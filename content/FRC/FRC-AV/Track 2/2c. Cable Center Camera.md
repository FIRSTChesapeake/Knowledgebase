...
1. Retrieve the center camera power adapter and mini-SDI to SDI cable (shown below) from the [[FRC/FRC-AV/index#Equipment Locations and Storage Descriptions|Storage Case]].
	![[PXL_20250228_141825751.jpg]]
2. Retrieve an extension cord and a tri-tap from the power [AV tote](FRC/FRC-AV/index.md#Equipment%20Locations%20and%20Storage%20Descriptions). The tri-tap may be located in one of the Streaming Unit drawers instead of the power tote.
...
3. Retrieve a bare SDI cable from the SDI [AV tote](FRC/FRC-AV/index.md#Equipment%20Locations%20and%20Storage%20Descriptions). These cable should not be in a sleeved bundle and should contain only the twist-lock BNC connector on the ends.
